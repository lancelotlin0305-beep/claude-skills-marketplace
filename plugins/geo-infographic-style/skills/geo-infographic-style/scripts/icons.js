...
const PATHS = {
  ...
  gear:        '<circle cx="12" cy="12" r="3.6"/><path d="M12 3.2v2.6M12 18.2v2.6M3.2 12h2.6M18.2 12h2.6M5.8 5.8l1.9 1.9M16.3 16.3l1.9 1.9M18.2 5.8l-1.9 1.9M7.7 16.3l-1.9 1.9"/>',
  sync:        '<path d="M20.2 12a8.2 8.2 0 01-13.9 5.9"/><path d="M3.8 12a8.2 8.2 0 0113.9-5.9"/><path d="M17.7 2.6v3.5h-3.5M6.3 21.4v-3.5h3.5"/>',
  cloudnet:    '<path d="M6.6 13.4a3.6 3.6 0 01.5-7.17 4.9 4.9 0 019.4 1.2 3.1 3.1 0 01-.5 6.03z"/><path d="M12 13.4v3.2M12 16.6l-4.4 2.6M12 16.6l4.4 2.6"/><circle cx="7.6" cy="19.8" r="1.6"/><circle cx="16.4" cy="19.8" r="1.6"/>',
  target:      '<circle cx="12" cy="12" r="8.4"/><circle cx="12" cy="12" r="4.6"/><circle cx="12" cy="12" r="1.2"/><path d="M12 3.6V1.4M20.4 12h2.2"/>',
  checkboard:  '<rect x="4.6" y="3.4" width="14.8" height="18" rx="2"/><path d="M9 3.4V2.2h6v1.2"/><path d="M8.6 10.2l1.8 1.8 3.6-3.6M8.6 16.2l1.8 1.8 3.6-3.6"/>',
  // fallback
