// [範例生成器] 流程/roadmap 平行卡版(16:9):階段卡 + 全寬淺色基礎橫帶 + 透明去背場景「浮貼」。
...
const x0=70,cw=428,gap=15,cy=200,ch=590,pad=22;
cards.forEach((cd,i)=>{
  const x=x0+i*(cw+gap),R=COL[cd.c];
  // 厚度邊 + 卡
...
// 基礎橫帶(全寬淺色)
const by=828,bh=210,bx=70,bw=W-140;
